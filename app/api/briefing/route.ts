...
const intelligenceConfigurations = [
  ...
  { id: "gpt_56_sol_ultra", model: "gpt-5.6-sol", effort: "ultra", label: "6 Sol ultra" },
  { id: "gpt_56_sol_max", model: "gpt-5.6-sol", effort: "max", label: "6 Sol max" },
  { id: "gpt_56_sol_xhigh", model: "gpt-5.6-sol", effort: "xhigh", label: "6 Sol xhigh" },
  { id: "gpt_56_sol_high", model: "gpt-5.6-sol", effort: "high", label: "6 Sol high" },
  { id: "gpt_56_sol_medium", model: "gpt-5.6-sol", effort: "medium", label: "6 Sol medium" },
  { id: "gpt_56_sol_low", model: "gpt-5.6-sol", effort: "low", label: "6 Sol low" },
  { id: "gpt_56_luna_max", model: "gpt-5.6-luna", effort: "max", label: "GPT-6 Luna max" },
  { id: "gpt_56_luna_xhigh", model: "gpt-5.6-luna", effort: "xhigh", label: "GPT-6 Luna xhigh" },
  { id: "gpt_56_luna_high", model: "gpt-5.6-luna", effort: "high", label: "GPT-6 Luna high" },
