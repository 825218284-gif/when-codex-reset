...
const intelligenceConfigurations = [
  ...
  { id: "gpt_56_luna_max", model: "gpt-5.6-luna", effort: "max", label: "Luna max" },
  { id: "gpt_56_luna_xhigh", model: "gpt-5.6-luna", effort: "xhigh", label: "Luna xhigh" },
  { id: "gpt_56_luna_high", model: "gpt-5.6-luna", effort: "high", label: "Luna high" },
